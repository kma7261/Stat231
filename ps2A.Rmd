...
> ANSWER: The number of observations is different because we had previously filtered for names where both `M` and `F` are greater than 10,000. Thus the total number of names has decreased dramatically. 
