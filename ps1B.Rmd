...
> ANSWER: The command does not turn the data points blue the code "color = "blue"" is within the aes function. As such, it is treated as an aesthetic, which means "blue" is treated as a variable rather than as an instruction. Because there is no variable "blue", all of the points are the default color. The command that will turn the points blue is:
ggplot(data = mpg) + 
