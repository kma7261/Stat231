...
Answer: The points become triangles when shape = 2. 
```{r, fig.width=10}
g <- g + geom_point(shape = 2)
g
```
```{r, fig.width=10}
g <- g + geom_point() + aes(shape = country)+
  labs(
      title = "Percentage of 'Yes' votes  on human rights issues in the UN General Assembly",
      subtitle = "1946 to 2015",
      y = "% Yes",
...
```{r, fig.width=10}
g <- g + geom_smooth() + aes(lty = country) +
      labs(
      title = "Percentage of 'Yes' votes  on human rights issues in the UN General Assembly",
      subtitle = "1946 to 2015",
      y = "% Yes",
