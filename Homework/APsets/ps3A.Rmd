...
> ANSWER: I am still not sure what the histogram does...what exactly is it plotting? Is starting the slider at 25 the default value? Why would the histogram change when we change the title...what if we only wanted to change the title?
...
ui <- fluidPage(
  ...
  #provides space to build the plot
  plotOutput("hist")
)
