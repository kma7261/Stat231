...
> ANSWER: The plan is to be able to create a script that can scrape all the data we need from those websites by Tuesday's class and spend the remainder of the week wrangling the data into formats that are needed for the visualizations. I have begun working on the script to scrape data for regular player statistics.
...
my_path <- "~/Github/Stat231/Homework/APsets"
